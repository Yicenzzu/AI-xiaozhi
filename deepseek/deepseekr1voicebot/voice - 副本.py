...
keyword = WakeupWord  
# 设置静音超时时间
# InitialSilenceTimeoutMs: 初始静音超时时间（毫秒）
#speech_config.set_property(speechsdk.PropertyId.SpeechServiceConnection_InitialSilenceTimeoutMs, "5000")  # 5 秒

# EndSilenceTimeoutMs: 结束静音超时时间（毫秒）
speech_config.set_property(speechsdk.PropertyId.SpeechServiceConnection_EndSilenceTimeoutMs, "1000")  # 3 秒
